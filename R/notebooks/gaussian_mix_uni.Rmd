...
$$
G_0(d\mu, d\sigma^2) = \mathcal N(d\mu \mid \mu_0,\, \sigma^2/\lambda) \times \mathcal{IG}(\sigma^2 | a, b)
$$
...
$$
\alpha = 1 \text{ and } \left(\mu_0,~\lambda,~a,~b\right) = \left(0,~0.1,~2,~2)\right)
$$
...
out = run_mcmc("NNIG", "DP", data, g0_params_allprior, dp_params_prior, neal2_algo,
               dens_grid=NULL, return_clusters=TRUE, return_num_clusters=TRUE, return_best_clus=TRUE)
```
