...
TEST(mfahierarchy, sample_full_cond) {
  auto hier = std::make_shared<MFAHierarchy>();
  bayesmix::MFAPrior prior;
  //Eigen::VectorXd mutilde = Eigen::VectorXd::Zero(20);

  Eigen::VectorXd mutilde(0);
  //mutilde << 1.1, 2.2, 3.1, 4.1, 4.8, 6.1, 6.9, 8.2, 9.0, 10.2, 11.2, 12.4, 13.5, 13.8, 14.5, 14.5, 17.8 , 18.1, 19.0, 21;
  bayesmix::Vector mutilde_proto;
  bayesmix::to_proto(mutilde, &mutilde_proto);
  ...
  Eigen::MatrixXd data = bayesmix::read_eigen_matrix("/home/giacomodecarlo/Desktop/bayesmixnew/bayesmix/examples/mfa_hierarchy/in/samplefullcond.csv"); 

  hier->set_dataset(&data);
  
  
  //beta << 100, 100, 100, 100, 100, 100 , 100, 100, 100, 100 ,100, 100, 100, 100, 100, 100, 100, 100, 100, 100;
  bayesmix::Vector beta_proto;
  bayesmix::to_proto(beta, &beta_proto);
  *prior.mutable_fixed_values()->mutable_mutilde() = mutilde_proto;
  prior.mutable_fixed_values()->set_phi(phi);
  ...
  *prior.mutable_fixed_values()->mutable_beta() = beta_proto;
  ...
  Eigen::MatrixXd Etasamplato(n_iter,q);
  ...
  for(unsigned int i = 0; i<n_iter; i++){
    ...
    Lambdasamplato.row(i) = (stato.lambda*(stato.lambda.transpose())).row(19);
  ...
  bayesmix::write_matrix_to_file(musamplato, "/home/giacomodecarlo/Desktop/bayesmixnew/bayesmix/examples/mfa_hierarchy/out/musamplatofull.csv");
  bayesmix::write_matrix_to_file(psisamplato, "/home/giacomodecarlo/Desktop/bayesmixnew/bayesmix/examples/mfa_hierarchy/out/psisamplatofull.csv");
  //bayesmix::write_matrix_to_file(Lambdasamplato, "/home/giacomodecarlo/Desktop/bayesmixnew/bayesmix/examples/mfa_hierarchy/out/Lambdasamplatofull1.csv");
  bayesmix::write_matrix_to_file(Lambdasamplato, "/home/giacomodecarlo/Desktop/bayesmixnew/bayesmix/examples/mfa_hierarchy/out/Lambdasamplatofullt.csv");
  bayesmix::write_matrix_to_file(Etasamplato, "/home/giacomodecarlo/Desktop/bayesmixnew/bayesmix/examples/mfa_hierarchy/out/Etasamplato.csv");
