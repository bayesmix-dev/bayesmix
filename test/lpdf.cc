...
//   // Compute pieces
//   double prior1 = stan::math::inv_gamma_lpdf(var, alpha0, beta0);
//   double prior2 = stan::math::multi_normal_prec_lpdf(mean, mu0, Lambda0 /
//   var); double pr = prior1 + prior2; double like = hier.get_like_lpdf(datum,
//   cov); double post1 = stan::math::inv_gamma_lpdf(var, alpha_n, beta_n);
//   double post2 =
