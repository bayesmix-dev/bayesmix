...
//! where f(x | phi_j) is a density for each value of phi_j and c_i take
//! values in {1, ..., k}.
...
//! The EPPF is represented as a `Mixing` object (inheriting from `AbstractMixing`).
//!
//! The state of a marginal algorithm consists of allocations and unique values
//! only. In this class of algorithms, the local lpdf estimate for
