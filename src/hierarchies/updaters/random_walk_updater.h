...
class RandomWalkUpdater: public MetropolisUpdater {
    ...
    public:
        ...
        Eigen::VectorXd sample_proposal(
                Eigen::VectorXd curr_state, AbstractLikelihood &like, 
        ...
        double proposal_lpdf(
                Eigen::VectorXd prop_state, Eigen::VectorXd curr_state, 
        ...
        void initialize(AbstractLikelihood& like, AbstractPriorModel& prior) override {
          ...
          std::shared_ptr<RandomWalkUpdater> clone() const {
            auto out =
                std::make_shared<RandomWalkUpdater>(static_cast<RandomWalkUpdater const &>(*this));
            return out;
        }
