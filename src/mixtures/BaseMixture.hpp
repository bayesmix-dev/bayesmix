...
//! integrates over a density kernel to generate the actual distribution for the
//! data. However, in the context of this library, where a clustering structure
//! is generated on the data, a certain mixture translates to a certain way of
//! weighing the insertion of data in old clusters vs the creation of new
//! clusters. Therefore any mixture object inheriting from the class must have
//! methods that provide the probabilities for the two aforementioned events.
