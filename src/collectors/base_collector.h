...
//! collector for short. 
//! A collector is used to store a sequence of Google Protobuf's objects
//! (also called messages), by serializing them. Data can be retrieved
//! and de-serialized into a Protobuf object, also in other programmin
//! languages.
...
class BaseCollector {
 public:
  ...
  //! Reads the next state and deserializes it into 
  //! the pointer `out`.
