...
class VariationInformation : public LossFunction {
 ...
 public:
  ...
  double JointEntropy();  // This method calculates the value on the members of
                          // LossFunction directly
  double MutualInformation();  // This method calculates the value on the
                               // members of LossFunction directly
  double Loss();
};
#endif